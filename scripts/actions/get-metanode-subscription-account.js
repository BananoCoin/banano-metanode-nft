...
// constants
const ACTION = 'get_metanode_subscription_account';
 ...
 * @return {undefined}
 */
const getBananodeApiUrl = async (context, req, res) => {
  ...
  const resp = {};
  resp.success = true;
  resp.metanode_subscription_account = config.metanodeSubscriptionAccount;

  res.send(resp);
};

const addAction = (actions) => {
  actions[ACTION] = getBananodeApiUrl;
};
