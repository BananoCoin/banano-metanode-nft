...
describe(actionUtil.ACTION, () => {
  ...
  it('get status 200 badContentTypeIpfsCid', async () => {
    ...
    const expectedResponse = {
      ...
      errors: ['unsupported content_type'],
  ...
  it('get status 200 badUnknownIpfsCid', async () => {
    ...
    const expectedResponse = {
      errors: ['unknown error from IPFS CID lookup', 'status:451', 'statusText:Unavailable For Legal Reasons'],
  ...
  it('get status 200 badAbortIpfsCid timeout abort', async () => {
    ...
    const expectedResponse = {
      errors: ['timeout waiting for response from IPFS CID lookup'],
  ...
  it('get status 200 badAbortOtherIpfsCid timeout abort', async () => {
    ...
    const expectedResponse = {
      errors: ['The user aborted a request with a wierd message.'],
